...
public class ParserTests
{
    ...
    [InlineData("\"hello world\".starts_with(\"hello\") && \"hello world\".ends_with(\"world\")")]    
    [InlineData("\"aaabde\".matches(\"a*c?.e\")")]
    [InlineData("\"aaabde\".contains(\"abd\")")]    
    [InlineData("\"aaabde\" == \"aaa\" + \"b\" + \"de\"")]
    [InlineData("\"abcD12\" == \"abcD12\"")]
    [InlineData("2019-12-04T09:46:41Z < 2020-12-04T09:46:41Z")]
    [InlineData("2020-12-04T09:46:41Z > 2019-12-04T09:46:41Z")]
    [InlineData("2019-12-04T09:46:41Z <= 2020-12-04T09:46:41Z")]
    [InlineData("2020-12-04T09:46:41Z >= 2020-12-04T09:46:41Z")]
    [InlineData("2020-12-04T09:46:41Z == 2020-12-04T09:46:41Z")]
    [InlineData("hex:12ab == hex:12ab")]
    [InlineData("[1, 2].contains(2)")]    
    [InlineData("[2019-12-04T09:46:41Z, 2020-12-04T09:46:41Z].contains(2020-12-04T09:46:41Z)")]
    [InlineData("[false, true].contains(true)")]
    [InlineData("[\"abc\", \"def\"].contains(\"abc\")")]
    [InlineData("[hex:12ab, hex:34de].contains(hex:34de)")]
    public void Should_Parse_Expression(string expression)
    {
        var parser = new Parser();
        var ops = parser.ParseExpression(expression);
